...
export const TRANSLATIONS = {
  tr: {
    ...
    conceptsMode: 'Görünüm',
    conceptsSingle: 'Kavram',
    conceptsPairs: 'Tamlama',
    conceptsSearch: 'Kavram ara: örtük bilgi, katman, geri bildirim…',
    conceptsTimes: 'kez',
    conceptsInDocs: 'yazıda',
    conceptsVariants: 'Biçimler',
  ...
  en: {
    ...
    conceptsMode: 'View',
    conceptsSingle: 'Concepts',
    conceptsPairs: 'Phrases',
    conceptsSearch: 'Search concepts: örtük bilgi, katman, geri bildirim…',
    conceptsTimes: 'times',
    conceptsInDocs: 'essays',
    conceptsVariants: 'Forms',
